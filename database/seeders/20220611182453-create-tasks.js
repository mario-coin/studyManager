...
module.exports = {
  up: (queryInterface, Sequelize) => {
    return queryInterface.bulkInsert('Tasks', [{
      ...
      start_date: new Date('2022-07-08 00:00:00'),
      ...
      start_date: new Date('2022-05-08 00:00:00'),
      ...
      start_date: new Date('2022-10-17 00:00:00'),
      ...
      start_date: new Date('2022-11-05 00:00:00'),
      ...
      start_date: new Date('2022-03-23 00:00:00'),
