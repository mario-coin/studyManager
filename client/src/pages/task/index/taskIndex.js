...
import { Switch, BrowserRouter, Route, Link  as LinkRouter, Redirect} from 'react-router-dom';
                      ...
                      <TableBody>
                        {this.state.tasks.map((row) => (
                          <TableRow key={row.id}>
                            ...
                            <BrowserRouter>
                              <LinkRouter to={`/task/delete/${row.id}`}><DeleteIcon/></LinkRouter>
                              <Route path="/task/delete/:id" component={Child}/>
                            </BrowserRouter>
                            </TableCell>
                          </TableRow>
                        ))}
